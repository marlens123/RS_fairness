...
data = dict(
    ...
    test=dict(
        ...
        vis=dict(
            ...
            params=dict(
                image_dir=[
                    "src/data/loveda/Vis_Geo/Rural/images_png/",
                    "src/data/loveda/Vis_Geo/Urban/images_png/",
                ],
                mask_dir=[
                    "src/data/loveda/Vis_Geo/Rural/masks_png/",
                    "src/data/loveda/Vis_Geo/Urban/masks_png/",
                ],
                transforms=Compose(
                    [
                        Normalize(
