...
python -m src.eval --pretraining_dataset "Satlas" --satlas_model_identifier "Sentinel2_SwinB_SI_RGB" --saved_weights "Satlas_Sentinel2_SwinB_SI_RGB_sgd_lr0100_model_weights.pth" --split "random"
python -m src.eval --pretraining_dataset "Satlas" --satlas_model_identifier "Sentinel2_Resnet50_SI_RGB" --saved_weights "Satlas_Sentinel2_Resnet50_SI_RGB_adamw_lr0100_model_weights.pth" --split "random"
